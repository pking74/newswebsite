...
export default function Page() {
  const highSchoolSports = sportsLinks.filter((link) => link.level === "High School");
  const collegeSports = sportsLinks.filter((link) => link.level === "College");
  const proSports = sportsLinks.filter((link) => link.level === "Pro");
